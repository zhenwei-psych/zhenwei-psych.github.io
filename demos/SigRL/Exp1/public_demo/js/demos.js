...
$(document).ready(function () {
									...
									function (demo) {
										return function (painter, location, agent) {
											...
											if (demo.points['agent1'] > 0) {
												demo.text_display.html('Each agent receives a point for getting to their home tile<br>For each point, you get $0.10<br>Your points: '+demo.points['agent1']);
											}
											//
	...
	endDemo = new GridWorldDemo(
		...
		,
		//initial text, display id, message id
		"That's the end of the demo! In the task, you will play <b>20 rounds</b> with <b>another Turker</b>. Press Enter to start the task.",
		'#task_display',
		'#messages'
	);
	endDemo.end = function () {
		$(window).unbind('beforeunload');
		$('#messages').text('End of Demo. Participants are paired with one another at this point.')
	}
})
